...
<html>
	<head>
		...
		<link rel="stylesheet" href="/css/events-in-ghana.css">
		<link rel="stylesheet" href="/css/footer.css">
		<link rel="icon" type="image/jpg" href="/img/icons/favicon.jpg">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<title>All upcoming events in Ghana - Wiki Ghana</title>
	</head>
	<body>
		<div class="wrap">
			...
			<div class="content_flex">
				<div class="content">
					...
					<div class="site_nav"><a href="/">Home</a> <i class="bi bi-arrow-right"></i> <a href="events-in-ghana.php">Events in Ghana</a></div>
					<div class="login">
						
						<h2 class="forgot-password">This page is under construction</h2>
