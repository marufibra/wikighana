...
<html>
	<head>
		...
		<title>Sports - Wiki Ghana</title>
		<link rel="canonical" href="/sports.php">
	</head>
	<body>
		<div class="wrap">
			...
			<div class="content_flex">
				<div class="content">
					...
					<div class="site_nav"><a href="/">Home</a> <i class="bi bi-arrow-right"></i> <a href="/sports.php">Sports</a></div>
					...
					<div class="category_name" style="margin:30px 0 10px 0;padding-left:10px">Top Stories (Sports)</a></span></div>
					<?php
					...
					if($records > $perPage){
						...
						echo '<div class="category_name" style="margin-top:0px;padding-left:10px" id="latest_news_58956">Latest Stories (Sports)</div>';
